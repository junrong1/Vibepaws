...
**Tier 0 total: ~20 days left** (28.5, minus 0.1 and 0.5 shipped 8/22, 0.10 and 0.12 shipped 8/25, and 0.13 shipped 9/4). Nothing here is differentiating; all of it is disqualifying if absent — and 0.9 is the item a user will notice within one session.
