...
| 13 | **Settings window** | all | ✅ **shipped 8/22** — pet name, token budget (global + per session), context thresholds, daily EXP cap, per-session goals, language. Autostart landed 9/5; scale and sound rows arrive with 0.2–0.3 |
