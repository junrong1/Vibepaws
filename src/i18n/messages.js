...
export const MESSAGES = {
  en: {
    ...
    "tray.scale": "Pet size: {state}",
    "tray.scale.small": "Small",
    "tray.scale.medium": "Medium",
    "tray.scale.large": "Large",
    "tray.display": "Displays: {state}",
    "tray.display.follow": "Follow the active display",
    "tray.display.pin": "Stay on one display",
    ...
    "settings.window.scale.label": "Pet size",
    "settings.window.scale.small": "Small",
    "settings.window.scale.medium": "Medium",
    "settings.window.scale.large": "Large",
    "settings.window.scale.hint": "Scales the pet, its bubbles, and the flyout together. The pet keeps its footing where it stands.",
    "settings.window.display.label": "Multiple displays",
    "settings.window.display.follow": "Follow the active display",
    "settings.window.display.pin": "Stay on one display",
    "settings.window.display.hint.follow":
      "The pet moves over once your cursor has settled on another display for a moment — a quick sweep across won't drag it along. Each display remembers where you last put the pet.",
    "settings.window.display.hint.pin":
      "The pet never moves on its own. Drag it to another display and it stays there instead.",
    "settings.window.display.here": "Pet is on: {name}",
    "settings.window.display.pinned": "Pinned to: {name}",
    "settings.window.display.pinned.gone": "Pinned to {name}, which isn't connected — the pet is on {here} until it's back.",
    "settings.window.display.single": "One display connected. This setting starts mattering when you plug in a second one.",
  ...
  "zh-CN": {
    ...
    "tray.scale": "宠物大小：{state}",
    "tray.scale.small": "小",
    "tray.scale.medium": "中",
    "tray.scale.large": "大",
    "tray.display": "显示器：{state}",
    "tray.display.follow": "跟随当前显示器",
    "tray.display.pin": "固定在一块屏上",
    "tray.core": "Core：{state}",
    ...
    "settings.window.scale.label": "宠物大小",
    "settings.window.scale.small": "小",
    "settings.window.scale.medium": "中",
    "settings.window.scale.large": "大",
    "settings.window.scale.hint": "宠物、气泡、浮层一起缩放。缩放时宠物脚下那一点不动。",
    "settings.window.display.label": "多显示器",
    "settings.window.display.follow": "跟随当前显示器",
    "settings.window.display.pin": "固定在一块屏上",
    "settings.window.display.hint.follow":
      "光标在另一块屏上停一会儿，宠物才搬过去 —— 一次划过去不会把它拽走。每块屏各自记住你上次把宠物放在哪。",
    "settings.window.display.hint.pin": "宠物不会自己移动。把它拖到哪块屏上，它就留在哪块屏上。",
    "settings.window.display.here": "宠物在：{name}",
    "settings.window.display.pinned": "固定在：{name}",
    "settings.window.display.pinned.gone": "固定在 {name}，但那块屏没接着 —— 接回来之前宠物待在 {here}。",
    "settings.window.display.single": "当前只接了一块屏。插上第二块时这一项才开始起作用。",
